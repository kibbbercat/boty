...
API_TOKEN = "1987020227:AAGw_1rsieKQUg_xmbmbbSv0s00IVLdDANU"
...
async def process_callback_del1(callback_query: types.CallbackQuery):
    await bot.answer_callback_query(callback_query.id, text="У тебя завтра нет \nникаких пар, отдыхай, \nи вообще ты крутой, \nвот ///")
    msg = callback_query.message
    rmsg = callback_query.message.reply_to_message
    asyncio.create_task(delete_message(msg, 0))
    asyncio.create_task(delete_message(rmsg, 0))
